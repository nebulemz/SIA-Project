        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-6">
              <h3>Customize your Layout: 11x6 Dimension</h3>
            </div>
            <div id = "form-container">
              <div class="row">
                     <div class="col-md-4" style = "padding-right: 140px; padding-left: 30px;" > <b style = "margin-top: 10px;"> ITEMS: </b>
                    ...
                    <div class="col-md-6">
                      <div id = "plane-container" style = "height: 311mm; width: 171mm; margin-left: -120px;">
                        <p>11x6</p>
                      </div>
                    </div> 
