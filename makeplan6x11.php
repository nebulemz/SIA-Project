            ...
            <div class = "col-sm-12 container" id = "form-container">
              <div class="row">
                    ...
                    <div class ="col-sm-12 elementToOverlay2" style = "width: 200px;">
                      <div class="dropzone element-trash" style = "text-align:center; font-size:smaller; height: 260px; float:right; margin-top:10px;margin-right:10px;"><b>DROP TO DELETE</b></div> 
                    </div>
